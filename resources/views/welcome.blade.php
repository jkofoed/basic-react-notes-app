    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0 text-gray-500">
                 The one, the only, the Notes.App page.   Add a note, edit a note, delete a note and see the notes.
                </div>
        ...
        <!-- loading the rest of the js deps -->
