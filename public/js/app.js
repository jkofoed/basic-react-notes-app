...
__webpack_require__(/*! ./notes */ "./resources/js/notes.js");
    ...
    value: function render() {
      {
        this.props.notes && this.props.notes.map(function (note) {
          ...
          }, note._id)), /*#__PURE__*/React.createElement("div", {
            "class": "ml-4"
          }, /*#__PURE__*/React.createElement("div", {
            "class": "mt-2 mr-2 text-gray-600 dark:text-gray-400 text-sm"
          }, note.note)))));
        });
      }
    }
...
var App = /*#__PURE__*/function (_React$Component2) {
  ...
  _createClass(App, [{
    ...
    value: function _delete(e) {
      ...
      e.preventDefault();
      // deletes entities
      fetch("http://notes.local:8000/api/notes/".concat(this.state.id), {
        "method": "DELETE"
      }).then(function (response) {
        return response.json();
      }).then(function (response) {
    ...
    value: function render() {
      ...
      }, "Add A Note"), /*#__PURE__*/React.createElement("label", {
        htmlFor: "notes"
